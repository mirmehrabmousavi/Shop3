                        ...
                        <div class="form-ui dt-sl dt-sn pt-4">
                            ...
                            <form id="reset-form" action="{{ route('front.user.password.update') }}" method="POST">
                                ...
                                <div class="form-row with-icon form-group">
                                    <input type="password" name="prev_password" class="input-ui pr-2" placeholder="رمز عبور خود را وارد نمایید">
                                ...
                                <div class="form-row with-icon form-group">
                                    <input id="password" type="password" name="password" class="input-ui pr-2" placeholder="رمز عبور جدید را وارد نمایید">
