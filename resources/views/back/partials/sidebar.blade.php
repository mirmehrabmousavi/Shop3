        ...
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto">
                <a class="navbar-brand" href="{{ url('/') }}" target="_blank">
                    <h2 class="brand-text mb-0">{{ option('info_site_title', 'سایت') }}</h2>
                </a></li>
        </ul>
    </div>
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="nav-item has-sub open">
                <a href="https://rayalanguage.com/admin/dashboard">
                    <i class="feather icon-home"></i>
                    <span class="menu-title">داشبورد ها</span>
                </a>
                <ul class="menu-content" style="">
                    <li class="is-shown"><a href="#"><i class="feather icon-circle"></i><span class="menu-item">ایندکس</span></a></li>
                    <li class="is-shown"><a href="#"><i class="feather icon-circle"></i><span class="menu-item">داشبورد</span></a></li>
                </ul>
            ...
            <li class="nav-item has-sub"><a href="#"><i class="feather icon-command"></i><span class="menu-title">خدماتی</span></a>
                <ul class="menu-content">
                    <li class="nav-item"><a href="{{ route('admin.dashboard') }}">
                            <i class="feather icon-home"></i>
                            <span class="menu-title">داشبورد</span>
