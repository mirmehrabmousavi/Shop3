    ...
    protected function orderValues(Request $request)
    {
        ...
        return response()->json(
            [
                'data' => $data,
                'meta' => [
                    'total'         => formatPriceUnits($total) . ' تومان',
                    'avg'           => formatPriceUnits($avg) . ' تومان',
                    'total_success' => formatPriceUnits($total_success) . ' تومان',
                    'total_fail'    => formatPriceUnits($total_fail) . ' تومان'
                ],
                'status' => 'success',
            ],
        );
